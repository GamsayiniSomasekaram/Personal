...
function Hero() {
  ...
  return (
   <>
   <section>
<div className="bg-gradient-to-b from-teal-100 to-teal-50  lg:h-screen " >
...
<div className="text-center lg:text-left lg:pt-30 lg:pl-20 pt-20">
  ...
  <h2 className=" text-3xl md:text-3xl lg:text-4xl text-emerald-950 pt-5  ">
                    I am a    {' '}
...
<div className=" md:flex  flex items-center justify-center space-x-4 pt-15 lg:justify-start ">
 <a href=''  className='relative px-6 py-3 bg-secoundary text-teal-50 rounded-full shadow-xl shadow-teal-950 transform hover:-translate-y-1 transition duration-300 flex gap-3 items-center justify-center font-bold text-xl '> <FaUsers /> View Projects</a>
<a href=''  className='relative px-6 py-3 bg-secoundary text-teal-50 rounded-full shadow-xl shadow-teal-950 transform hover:-translate-y-1 transition duration-300 flex gap-3 items-center  justify-center  font-bold text-xl '> <MdOutlineMessage /> Contact Me</ a>
</div>
<div className=" md:flex  flex items-center justify-center space-x-4 pt-15 lg:justify-start cursor-auto ">
<a href='' className='bg-secoundary p-6 rounded-full shadow-lg shadow-secoundary animate-bounce text-2xl  font-bold text-teal-50 border-2 border-white'><FaFacebookF /> </a>
<a href=''  className='bg-secoundary p-6 rounded-full shadow-lg shadow-teal-900 animate-bounce text-2xl  font-bold text-teal-50 border-2 border-white'><FaInstagram /></a>
  <a  href='' className='bg-secoundary p-6 rounded-full shadow-lg shadow-teal-900 animate-bounce text-2xl  font-bold text-teal-50 border-2 border-white'><BiLogoGmail /> </a></div>
</div>
